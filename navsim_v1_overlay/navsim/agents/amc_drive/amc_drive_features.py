...
class AMCDriveFeatureBuilder(AbstractFeatureBuilder):
    def __init__(self, config: AMCDriveConfig):
        self._config = config

    def get_unique_name(self) -> str:
        """Inherited, see superclass."""
        return "amc_drive_feature"
    ...
    def _get_camera_feature(self, agent_input: AgentInput) -> Dict[str, torch.Tensor]:
        ...
        features = {
            'camera_feature_1': tensor_image_1,
            'camera_feature_2': tensor_image_2,
        }
        return features 
...
class AMCDriveTargetBuilder(AbstractTargetBuilder):
    def __init__(self, config: AMCDriveConfig):
        self._config = config

    def get_unique_name(self) -> str:
        """Inherited, see superclass."""
        return "amc_drive_target"
    ...
    def _compute_agent_targets(self, annotations: Annotations) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        def _xy_in_lidar(x: float, y: float, config: AMCDriveConfig) -> bool:
